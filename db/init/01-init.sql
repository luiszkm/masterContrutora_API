...
DELETE CASCADE,
    funcionario_id UUID
NOT NULL REFERENCES funcionarios
(id) ON
DELETE CASCADE,
...
CREATE TABLE
IF NOT EXISTS apontamentos_quinzenais
(
    id UUID PRIMARY KEY,
    funcionario_id UUID NOT NULL REFERENCES funcionarios
(id),
    obra_id UUID NOT NULL REFERENCES obras
(id),
...
CREATE TABLE
IF NOT EXISTS registros_pagamento
(
    id UUID PRIMARY KEY,
    funcionario_id UUID NOT NULL REFERENCES funcionarios
(id),
...
(obra_id);
CREATE INDEX
IF NOT EXISTS idx_alocacoes_funcionario_id ON alocacoes
(funcionario_id);
CREATE INDEX
IF NOT EXISTS idx_materiais_categoria ON materiais
(categoria);
CREATE INDEX
IF NOT EXISTS idx_apontamentos_funcionario_id ON apontamentos_quinzenais
(funcionario_id);
CREATE INDEX
IF NOT EXISTS idx_pagamentos_funcionario_id ON registros_pagamento
(funcionario_id);
CREATE INDEX
